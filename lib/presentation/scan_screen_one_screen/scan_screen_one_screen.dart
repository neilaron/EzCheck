...
class ScanScreenOneScreen extends StatelessWidget {
  const ScanScreenOneScreen({Key? key}) : super(key: key);
  ...
  true, // Use flash
  ScanMode.BARCODE, // Specify the type of scan (e.g., barcode or QR code)
      );
