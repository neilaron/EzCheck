...
class ScanScreenTwoScreen extends StatelessWidget {
  const ScanScreenTwoScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the qauntityOneScreen when the action is triggered.
  onTapWidget(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.qauntityOneScreen);
  }
}
