...
class QauntityScreen extends StatelessWidget {
  QauntityScreen({Key? key}) : super(key: key);

  TextEditingController nestlGlobalValueController = TextEditingController();
        ...
        child: Scaffold(
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  ...
                  SizedBox(height: 7.v),
                  _buildNestlGlobalValue(context),
                  SizedBox(height: 9.v),
                  Align(
                      alignment: Alignment.centerLeft,
                      child: Padding(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    CustomImageView(
                        ...
                        height: 29.adaptSize,
                        width: 29.adaptSize,
                        margin: EdgeInsets.only(left: 28.h, top: 1.v))
                  ]),
  ...
  /// Section Widget
  Widget _buildNestlGlobalValue(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 32.h, right: 31.h),
        child: CustomTextFormField(
            controller: nestlGlobalValueController,
