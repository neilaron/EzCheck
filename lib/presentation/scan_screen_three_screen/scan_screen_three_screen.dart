...
class ScanScreenThreeScreen extends StatelessWidget {
  const ScanScreenThreeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the scanScreenFourScreen when the action is triggered.
  onTapFiftyTwo(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.scanScreenFourScreen);
  }
}
